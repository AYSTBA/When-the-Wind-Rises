...
export function PostEngagementBar({ postId, postSlug, author, likeCount, favoriteCount = 0, initialLiked = false, initialFavored = false, canReport = false, reportLabel = "当前风笺" }: PostEngagementBarProps) {
