...
export const ADDON_SURFACE_CATALOG = [
  ...
  surface("board.content", "接管节点风笺流区域。"),
  ...
  surface("collection.content", "接管单合集已收录风笺区。", { mode: "client" }),
  ...
  surface("post.header", "接管风笺详情头部信息区。"),
  surface("post.body", "接管风笺正文、附件与风笺类型扩展区。"),
  surface("post.author.row", "接管风笺作者行。"),
  surface("post.author.meta", "接管风笺作者元信息区。"),
  surface("post.author.verification", "接管风笺作者认证标识。"),
  surface("post.author.name", "接管风笺作者名称区。"),
  surface("post.author.badges", "接管风笺作者勋章区。"),
  surface("post.create.form", "接管发笺表单整体。", { mode: "client" }),
  surface("post.create.tools", "接管发笺基础设置区。", { mode: "client" }),
  surface("post.create.editor", "接管发笺正文编辑器。", { mode: "client" }),
  surface("post.create.enhancements", "接管发笺增强功能区。", { mode: "client" }),
  surface("post.create.submit", "接管发笺提交区。", { mode: "client" }),
  surface("post.weibo.feed", "接管微博模式风笺流。", { mode: "client" }),
  ...
  surface("settings.post-management", "接管风笺管理分区。"),
  ...
  surface("terms.page", "接管风广场协议页主体区域。"),
  surface("terms.hero", "接管风广场协议顶部介绍区。"),
  surface("terms.content", "接管风广场协议正文区。"),
  surface("terms.sidebar", "接管风广场协议页右侧栏。"),
  ...
  surface("topup.page", "接管风铃充值页主体区域。"),
  ...
  surface("write.page", "接管发笺页主体区域。"),
  surface("write.header", "接管发笺页标题区。"),

  surface("zone.page", "接管分区页主体区域。"),
  surface("zone.hero", "接管分区信息区。"),
  surface("zone.content", "接管分区风笺流。"),
